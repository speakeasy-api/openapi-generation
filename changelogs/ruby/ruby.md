...
### :bug: Bug Fixes
- disable Style/CaseLikeIf rubocop warning *(commit by [@TristanSpeakeasy](https://github.com/TristanSpeakeasy))*
...
### :bug: Bug Fixes
- fixes for passing nil as an optional request body *(commit by [@idbentley](https://github.com/idbentley))*
...
### :wrench: Chores
- remove redundant returns to improve idiomaticness of generated code *(commit by [@ThomasRooney](https://github.com/ThomasRooney))*
