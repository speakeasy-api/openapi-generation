...
func TestSnapGoQueryMethod(t *testing.T) {
	t.Parallel()

	// Tests OpenAPI 3.2 QUERY HTTP method only (isolated from additionalOperations)
	spec := `openapi: "3.2.0"
info:
...
paths:
  /search:
    query:
      ...
      summary: Search items using QUERY method
      requestBody:
        required: true
        content:
          application/json:
...
components:
  schemas:
	...
	genYaml := `go:
  packageName: github.com/example/querymethod
`
...
--- models/components/searchrequest.go ---
// Code generated by Speakeasy (https://speakeasy.com). DO NOT EDIT.
// Generated under the AGPL-3.0-only license.
// SPDX-License-Identifier: AGPL-3.0-only
...
func (s *SearchRequest) GetLimit() *int64 {
	if s == nil {
		return nil
	}
	return s.Limit
...
import (
	"errors"
	"github.com/example/querymethod/internal/utils"
	"github.com/example/querymethod/retry"
	"time"
)
...
--- models/operations/searchitems.go ---
// Code generated by Speakeasy (https://speakeasy.com). DO NOT EDIT.
// Generated under the AGPL-3.0-only license.
// SPDX-License-Identifier: AGPL-3.0-only
...
import (
	"github.com/example/querymethod/internal/utils"
	"github.com/example/querymethod/models/components"
)
...
func (s SearchItemsResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(s, "", false)
}

func (s *SearchItemsResponse) UnmarshalJSON(data []byte) error {
...
func (s *SearchItemsResponse) GetHTTPMeta() components.HTTPMetadata {
	if s == nil {
...
func (s *SearchItemsResponse) GetItems() []components.Item {
	if s == nil {
		return nil
	}
	return s.Items
...
import (
	...
	"context"
	"fmt"
	"github.com/example/querymethod/internal/config"
	"github.com/example/querymethod/internal/hooks"
	"github.com/example/querymethod/internal/utils"
	"github.com/example/querymethod/models/apierrors"
	"github.com/example/querymethod/models/components"
	"github.com/example/querymethod/models/operations"
	"github.com/example/querymethod/retry"
	"net/http"
	"net/url"
	"time"
...
func New(serverURL string, opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.0.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:         "speakeasy-sdk/go 0.0.1 internal 1.0.0 github.com/example/querymethod",
			SDKVersion:        "0.0.1",
			GenVersion:        "internal",
...
// SearchItems - Search items using QUERY method
func (s *SDK) SearchItems(ctx context.Context, request components.SearchRequest, opts ...operations.Option) (*operations.SearchItemsResponse, error) {
	...
	req, err := http.NewRequestWithContext(ctx, "QUERY", opURL, bodyReader)
	if err != nil {
	...
	res := &operations.SearchItemsResponse{
