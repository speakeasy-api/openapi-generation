...
public class ServersShould
{
    ...
    public async Task SelectGlobalServerValid()
    {
        ...
        Assert.Equal(url, sdk.SDKConfiguration.GetTemplatedServerUrl());
    ...
    public async Task SelectServerWithIDDefault()
    {
        ...
        var res = await sdk.Servers.SelectServerWithIDAsync(serverUrl: Helpers.HttpBinUrl);
        Assert.Equal(HttpStatusCode.OK, res.HttpMeta.Response.StatusCode);
    }
    ...
    public async Task ServerWithTemplatesGlobalEnum()
    {
        ...
        var sdk = new SDK(serverUrl: $"{Helpers.HttpBinUrl}/anything/{Openapi.ServerSomething.SomethingElseAgain.Value()}");
