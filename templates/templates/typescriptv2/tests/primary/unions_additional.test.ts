...
import { Decimal } from "../sdk/types/decimal.js";
...
} from "../sdk/models/shared/simpleobjectwithnonstandardtypename.js";
import {
...
import {
  TypedObject1,
  TypedObject1Type,
} from "../sdk/models/shared/typedobject1.js";
...
test("typed object one of post null", async () => {
  ...
  try {
    ...
    if (!cause?.name?.includes("ZodError")) {
      expect.unreachable(
