...
def create_simple_object():
    return shared.SimpleObject(
        ...
        bool_opt=True,
        date_=date(2020, 1, 1),
        date_time=datetime(2020, 1, 1, 0, 0, 0, 1, timezone.utc),
        enum="one",
        float32=1.1,
        int_=1,
        int32=1,
...
def create_simple_object_camel_case():
    return shared.SimpleObjectCamelCase(
        ...
        date_time_val=datetime(2020, 1, 1, 0, 0, 0, 1, timezone.utc),
        enum_val="one",
        float32_val=1.1,
        int_val=1,
        int32_val=1,
...
def compare_deep_object(obj1: shared.DeepObject, obj2: shared.DeepObject):
    ...
    for i, elem in enumerate(obj1.arr):
        compare_simple_object(elem, obj2.arr[i])
    assert obj1.bool_ == obj2.bool_
    assert obj1.int_ == obj2.int_
