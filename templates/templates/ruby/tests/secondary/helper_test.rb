...
def create_simple_object
  AlphabeticallyEarly::Models::Shared::SimpleObject.new(
    str_: "test",
    bool: true,
    int: 1,
    int32: 1,
    int32_enum: AlphabeticallyEarly::Models::Shared::Int32Enum::FIFTY_FIVE,
    int_enum: AlphabeticallyEarly::Models::Shared::IntEnum::SECOND,
    num: 1.1,
    float32: 1.1,
    enum: AlphabeticallyEarly::Models::Shared::Enum::ONE,
    any: "any",
...
def create_simple_object_with_type
  AlphabeticallyEarly::Models::Shared::SimpleObjectWithType.new(
    str_: "test",
    bool: true,
    int: 1,
    int32: 1,
    int32_enum: AlphabeticallyEarly::Models::Shared::SimpleObjectWithTypeInt32Enum::FIFTY_FIVE,
    int_enum: AlphabeticallyEarly::Models::Shared::SimpleObjectWithTypeIntEnum::SECOND,
    num: 1.1,
    float32: 1.1,
    enum: AlphabeticallyEarly::Models::Shared::Enum::ONE,
    any: "any",
...
def create_simple_object_with_non_standard_type_name
  AlphabeticallyEarly::Models::Shared::SimpleObjectWithNonStandardTypeName.new(
    str_: "test",
    bool: true,
    int: 1,
    int32: 1,
    int32_enum: AlphabeticallyEarly::Models::Shared::SimpleObjectWithNonStandardTypeNameInt32Enum::FIFTY_FIVE,
    int_enum: AlphabeticallyEarly::Models::Shared::SimpleObjectWithNonStandardTypeNameIntEnum::SECOND,
    num: 1.1,
    float32: 1.1,
    enum: AlphabeticallyEarly::Models::Shared::Enum::ONE,
    any: "any",
...
def create_deep_object
  AlphabeticallyEarly::Models::Shared::DeepObject.new(
...
def create_deep_object_with_type
  AlphabeticallyEarly::Models::Shared::DeepObjectWithType.new(
    any: create_simple_object,
    arr: [create_simple_object, create_simple_object],
    bool: true,
    int: 1,
