...
module OpenApiSDK
  class TestParameter < Minitest::Test
    ...
    def test_mixed_parameters_primitives
      ...
      refute_nil(res.res)
      assert_equal(
        "#{CommonHelpers.httpbin_url}/anything/mixedParams/path/pathValue?queryStringParam=queryValue",
        res.res.url
      )
    ...
    def test_simple_path_parameter_primitives
      ...
      res = @sdk
        .parameters
        .simple_path_parameter_primitives(bool_param: true, int_param: 1, num_param: 1.1, str_param: "test")
      refute_nil(res)
      assert_equal(Rack::Utils.status_code(:ok), res.http_meta.response.status)
      refute_nil(res.res)
      assert_equal("#{CommonHelpers.httpbin_url}/anything/pathParams/str/test/bool/true/int/1/num/1.1", res.res.url)
    end
    ...
    def test_simple_path_parameter_arrays
      ...
      res = @sdk.parameters.simple_path_parameter_arrays(arr_param: ["test", "test2"])
      refute_nil(res)
      assert_equal(Rack::Utils.status_code(:ok), res.http_meta.response.status)
      refute_nil(res.res)
      assert_equal("#{CommonHelpers.httpbin_url}/anything/pathParams/arr/test,test2", res.res.url)
    end
    ...
    def test_simple_path_parameter_maps
      ...
      refute_nil(res.res)
      assert_equal(
        "#{CommonHelpers.httpbin_url}/anything/pathParams/map/test,value,test2,value2/mapExploded/test=1,test2=2",
        sort_serialized_map(res.res.url, ".*?\\/map\\/(.*?)\\/mapExploded\\/(.*)")
      )
    end
    ...
    #   assert_equal(Rack::Utils.status_code(:ok), res.http_meta.response.status)
    #   refute_nil(res.res)
    #   assert_equal("#{CommonHelpers.httpbin_url}/anything/pathParams/json/{'any': 'any', 'bool': true, 'date': '2020-01-01', 'dateTime': '2020-01-01T00:00:00.000001Z', 'enum': 'one', 'float32': 1.1, 'int': 1, 'int32': 1, 'num': 1.1, 'str': 'test', 'boolOpt': true, 'strOpt': 'testOptional'}", res.res.url)
    # end
    ...
    def test_form_query_params_primitive
      ...
      res = @sdk
        .parameters
        .form_query_params_primitive(bool_param: true, int_param: 1, num_param: 1.1, str_param: "test")
      refute_nil(res)
      assert_equal(Rack::Utils.status_code(:ok), res.http_meta.response.status)
      refute_nil(res.res)
    ...
    def test_form_query_params_object
      ...
      assert_equal(
        "any,any,bool,true,date,2020-01-01,dateTime,2020-01-01T00:00:00.000000001Z,enum,one,float32,1.1,int,1,int32,1,int32Enum,55,intEnum,2,num,1.1,str,test,boolOpt,true,strOpt,testOptional",
        res.res.args.obj_param
      )
    end
    ...
    def test_form_query_params_ref_param_object
      ...
      res = @sdk.parameters.form_query_params_ref_param_object(
        ref_obj_param: Models::Shared::RefQueryParamObj.new(
          bool: true,
          int: 1,
          num: 1.1,
          str_: "test"
        ),
        ref_obj_param_exploded: Models::Shared::RefQueryParamObjExploded.new(
          bool: true,
          int: 1,
          num: 1.1,
          str_: "test"
      ...
      refute_nil(res.res)
      assert_equal(
        "#{CommonHelpers.httpbin_url}/anything/queryParams/form/refParamObject?bool=true&int=1&num=1.1&refObjParam=bool%2Ctrue%2Cint%2C1%2Cnum%2C1.1%2Cstr%2Ctest&str=test",
        res.res.url
      )
      assert_equal("test", res.res.args.str_)
      assert_equal("true", res.res.args.bool)
    ...
    def test_form_query_params_array
      ...
      refute_nil(res.res)
      assert_equal(
        "#{CommonHelpers.httpbin_url}/anything/queryParams/form/array?arrParam=test%2Ctest2&arrParamExploded=1&arrParamExploded=2",
        res.res.url
      )
    ...
    def test_form_query_params_map
      ...
      refute_nil(res.res)
      assert_equal(
        "#{CommonHelpers.httpbin_url}/anything/queryParams/form/map?mapParam=test,value,test2,value2&test=1&test2=2",
        sort_serialized_map(res.res.url, ".*?\\?mapParam=(.*?)&(.*)")
      )
    ...
    def test_deep_object_query_params_object
      ...
      res = @sdk.parameters.deep_object_query_params_object(
        obj_param: obj,
        obj_arr_param: Models::Operations::ObjArrParam.new(
          arr: ["test", "test2"]
        )
      )
      ...
      refute_nil(res.res)
      assert_equal(
        "#{CommonHelpers.httpbin_url}/anything/queryParams/deepObject/obj?objArrParam[arr]=test&objArrParam[arr]=test2&objParam[any]=any&objParam[boolOpt]=true&objParam[bool]=true&objParam[dateTime]=2020-01-01T00%3A00%3A00.000000001Z&objParam[date]=2020-01-01&objParam[enum]=one&objParam[float32]=1.1&objParam[int32Enum]=55&objParam[int32]=1&objParam[intEnum]=2&objParam[int]=1&objParam[num]=1.1&objParam[strOpt]=testOptional&objParam[str]=test",
        res.res.url
      )
    ...
    def test_deep_object_query_params_map
      ...
      refute_nil(res.res)
      assert_equal(
        "#{CommonHelpers.httpbin_url}/anything/queryParams/deepObject/map?mapArrParam[test2]=test3&mapArrParam[test2]=test4&mapArrParam[test]=test&mapArrParam[test]=test2&mapParam[test2]=value2&mapParam[test]=value",
        res.res.url
      )
    ...
    def test_header_params_object
      ...
      assert_equal(
        "any,any,bool,true,date,2020-01-01,dateTime,2020-01-01T00:00:00.000000001Z,enum,one,float32,1.1,int,1,int32,1,int32Enum,55,intEnum,2,num,1.1,str,test,boolOpt,true,strOpt,testOptional",
        res.res.headers.x_header_obj
      )
      assert_equal(
        "any=any,bool=true,date=2020-01-01,dateTime=2020-01-01T00:00:00.000000001Z,enum=one,float32=1.1,int=1,int32=1,int32Enum=55,intEnum=2,num=1.1,str=test,boolOpt=true,strOpt=testOptional",
        res.res.headers.x_header_obj_explode
      )
    end
