...
function isTestSkipped(test: string): boolean {
  return [
    ...
    "request-bodies-post-json-data-types-array-bigint",
    "request-bodies-post-json-data-types-array-date",
    "request-bodies-post-json-data-types-array-decimal-str",
    "request-bodies-post-json-data-types-bigint",
    "request-bodies-post-json-data-types-bigint-str",
    "request-bodies-post-json-data-types-boolean",
    "request-bodies-post-json-data-types-complex-number-arrays",
    "request-bodies-post-json-data-types-complex-number-maps",
    "request-bodies-post-json-data-types-date",
    "request-bodies-post-json-data-types-date-time",
    "request-bodies-post-json-data-types-decimal",
    "request-bodies-post-json-data-types-decimal-str",
    "request-bodies-post-json-data-types-float32",
    "request-bodies-post-json-data-types-int32",
    "request-bodies-post-json-data-types-integer",
    "request-bodies-post-json-data-types-map-bigint-str",
    "request-bodies-post-json-data-types-map-date-time",
    "request-bodies-post-json-data-types-map-decimal",
    "request-bodies-post-json-data-types-number",
    "request-bodies-post-json-data-types-string",
    "request-bodies-post-nullable-required-string-body",
    ...
    "response-bodies-default-empty-string",
    ...
    "request-bodies-post-nullable-optional-fields",
