...
final class AuthTest extends TestCase
{
    ...
    public function testBasicAuth(): void
    {
        ...
        $response = $sdk->authNew->basicAuthNew($security, $request);
    ...
    public function testApiKeyAuthGlobal(): void
    {
        ...
        $sdk = \OpenAPI\OpenAPI\SDK::builder()->setServerUrl(CommonHelpers::getHttpBinUrl())->setSecurity($security)->build();
    ...
    public function testOpenIdConnectAuth(): void
    {
        ...
        $response = $sdk->authNew->openIdConnectAuthNew($security, $request);
    ...
    public function testMultipleSimpleSchemeAuth(): void
    {
        ...
        $response = $sdk->authNew->multipleSimpleSchemeAuth($security, $request);
    ...
    public function testMultipleMixedSchemeAuth(): void
    {
        ...
        $response = $sdk->authNew->multipleMixedSchemeAuth($security, $request);
    ...
    public function testMultipleSimpleOptionsAuthFirstOption(): void
    {
        ...
        $response = $sdk->authNew->multipleSimpleOptionsAuth($security, $request);
    ...
    public function testMultipleMixedOptionsAuthFirstOption(): void
    {
        ...
        $response = $sdk->authNew->multipleMixedOptionsAuth($security, $request);
    ...
    public function testMultipleOptionsWithSimpleSchemesAuthFirstOption(): void
    {
        ...
        $response = $sdk->authNew->multipleOptionsWithSimpleSchemesAuth($security, $request);
    ...
    public function testMultipleOptionsWithMixedSchemesAuthFirstOption(): void
    {
        ...
        $response = $sdk->authNew->multipleOptionsWithMixedSchemesAuth($security, $request);
    ...
    public function testFunctionCallbacksForOAuthSupportGlobalSecurity(): void
    {
        ...
        $sdk = \OpenAPI\OpenAPI\SDK::builder()->setServerUrl(CommonHelpers::getHttpBinUrl())->setSecuritySource(function () {
    ...
    public function testCustomSecurityOptionAddId(): void
    {
        ...
        $sdk = \OpenAPI\OpenAPI\SDK::builder()->setServerUrl(CommonHelpers::getHttpBinUrl())
            ->setSecuritySource(function () {
                return new \OpenAPI\OpenAPI\Models\Shared\Security(
                    customSchemeAppId: new \OpenAPI\OpenAPI\Models\Shared\SchemeCustomSchemeAppID(
                        appId: 'testAppID',
                        secret: 'testSecret'
                    )
                );
