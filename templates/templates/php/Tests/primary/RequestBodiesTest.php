...
final class RequestBodiesTest extends TestCase
{
    ...
    public function testRequestBodyPostApplicationJsonMapOfAny(): void
    {
        ...
        $mAny = [
            'mapElemArray' => ['array-test'],
            'mapElemBool' => true,
            'mapElemNumber' => 123,
            'mapElemObject' => [
                'property' => 'property-test',
            ],
            'mapElemString' => "string-test",
        ];

        $response = $sdk->requestBodies->requestBodyPostApplicationJsonMapOfAny($mAny);

        $this->assertNotNull($response);
        $this->assertEquals(200, $response->httpMeta->response->getStatusCode());
        $this->assertNotNull($response->res);
        Helpers::assertEquivalent($this, $mAny, $response->res);
    }
    ...
    public function testRequestBodyPutMultipartFile(): void
    {
        ...
        $request = new \OpenAPI\OpenAPI\Models\Operations\RequestBodyPutMultipartFileRequestBody(
            file: new \OpenAPI\OpenAPI\Models\Operations\RequestBodyPutMultipartFileFile(
    ...
    public function testRequestBodyNoBodyNoContentType(): void
    {
        ...
        $response = $sdk->methods->methodGet(Helpers::getApiTestServiceUrl());
    ...
    public function testRequestBodyPostComplexNumberTypes(): void
    {
        ...
        $this->assertEquals($req->complexNumberTypes->int64Str, $res->object->json->int64Str);
        $this->assertEquals($req->complexNumberTypes->float64Str, $res->object->json->float64Str);
        $this->assertEquals(
            Helpers::getHttpBinUrl() . '/anything/requestBodies/post/9007199254740991/"9223372036854775807"/3.1415926535898/"3.141592653589793238462643383279"/100/1.1/complex-number-types?queryBigInt=9007199254740991&queryBigIntStr="9223372036854775807"&queryDecimal=3.1415926535898&queryDecimalStr="3.141592653589793238462643383279"&queryFloat64Str=1.1&queryInt64Str=100', $res->object->url);
    }

    public function testRequestBodyPostBigIntAboveIntMaxThrows(): void
    {
        CommonHelpers::recordTest('request-bodies-complex-number-types-bigint-overflow');

        $sdk = \OpenAPI\OpenAPI\SDK::builder()->setServerUrl(Helpers::getHttpBinUrl())->build();

        $req = new Operations\RequestBodyPostComplexNumberTypesRequest(
            complexNumberTypes: new Shared\ComplexNumberTypes(
                bigint: \Brick\Math\BigInteger::of('35012345678901234567'),
                bigintStr: \Brick\Math\BigInteger::of('35012345678901234567'),
                decimal: \Brick\Math\BigDecimal::of('3.1415926535898'),
                decimalStr: \Brick\Math\BigDecimal::of('3.141592653589793238462643383279'),
                float64Str: '1.1',
                int64Str: '100'
            ),
            pathBigInt: \Brick\Math\BigInteger::of('35012345678901234567'),
            pathBigIntStr: \Brick\Math\BigInteger::of('35012345678901234567'),
            pathDecimal: \Brick\Math\BigDecimal::of('3.1415926535898'),
            pathDecimalStr: \Brick\Math\BigDecimal::of('3.141592653589793238462643383279'),
            pathFloat64Str: '1.1',
            pathInt64Str: '100',
            queryBigInt: \Brick\Math\BigInteger::of('35012345678901234567'),
            queryBigIntStr: \Brick\Math\BigInteger::of('35012345678901234567'),
            queryDecimal: \Brick\Math\BigDecimal::of('3.1415926535898'),
            queryDecimalStr: \Brick\Math\BigDecimal::of('3.141592653589793238462643383279'),
            queryFloat64Str: '1.1',
            queryInt64Str: '100'
        ...
        $this->expectException(\Brick\Math\Exception\IntegerOverflowException::class);

        $sdk->requestBodies->requestBodyPostComplexNumberTypes($req);
    }

    public function testRequestBodyPutMultipartFilesArray(): void
    {
        CommonHelpers::recordTest('request-bodies-post-multipart-files-array');

        $sdk = \OpenAPI\OpenAPI\SDK::builder()->setServerUrl(Helpers::getApiTestServiceUrl())->build();
        ...
        $request = new \OpenAPI\OpenAPI\Models\Operations\RequestBodyPutMultipartFilesArrayRequestBody(
            files: [
                new \OpenAPI\OpenAPI\Models\Operations\RequestBodyPutMultipartFilesArrayFiles(
                    fileName: 'testUpload.json',
                    content: $content
                ),
                new \OpenAPI\OpenAPI\Models\Operations\RequestBodyPutMultipartFilesArrayFiles(
        ...
        $response = $sdk->requestBodies->requestBodyPutMultipartFilesArray($request);
        ...
        $expectedFiles = [
            new \OpenAPI\OpenAPI\Models\Operations\RequestBodyPutMultipartFilesArrayRequestBodiesFiles(
                content: 'ewogICJzb21lIjogImpzb24iLAogICJ0byI6ICJiZSIsCiAgInVwbG9hZGVkIjogImluIiwKICAiYSI6ICJmaWxlIgp9Cg==',
        ...
        $expectedResponse = new \OpenAPI\OpenAPI\Models\Operations\RequestBodyPutMultipartFilesArrayRes(
            files: $expectedFiles,
            formFields: []
        );

        $this->assertEquals($expectedResponse, $response->res);
    }
