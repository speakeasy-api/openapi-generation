...
final class GlobalsAdditionalTest extends TestCase
{
    public function testGlobalsQueryParameterGetUsesGlobal(): void
    {
        ...
        $sdk = \OpenAPI\OpenAPI\SDK::builder()->setServerUrl(Helpers::getHttpBinUrl())->setGlobalQueryParam('test')->build();
    ...
    public function testGlobalPathParameterGetUsesGlobal(): void
    {
        ...
        $sdk = \OpenAPI\OpenAPI\SDK::builder()->setServerUrl(Helpers::getHttpBinUrl())->setGlobalPathParam(1)->build();
        ...
        $this->assertNotNull($response);
        $this->assertEquals(200, $response->httpMeta->response->getStatusCode());
        $this->assertEquals(Helpers::getHttpBinUrl() . '/anything/globals/pathParameter/1', $response->res->url);
    }
    ...
    public function testGlobalPathParameterGetUsesLocal(): void
    {
        ...
        $this->assertNotNull($response);
        $this->assertEquals(200, $response->httpMeta->response->getStatusCode());
        $this->assertEquals(Helpers::getHttpBinUrl() . '/anything/globals/pathParameter/2', $response->res->url);
    }
    ...
    public function testGlobalHeaderGetUsesGlobal(): void
    {
        ...
        $sdk = \OpenAPI\OpenAPI\SDK::builder()->setServerUrl(Helpers::getHttpBinUrl())->setGlobalHeaderParam(true)->build();
