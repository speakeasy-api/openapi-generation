...
final class ServersTest extends TestCase
{
    ...
    public function testSelectGlobalServerByNameBroken(): void
    {
        ...
        $sdk = \OpenAPI\OpenAPI\SDK::builder()->setServer(\OpenAPI\OpenAPI\SDK::SERVER_BROKEN)->build();
    ...
    public function testSelectGlobalServerByNameWithTemplatesValid(): void
    {
        ...
        $sdk = \OpenAPI\OpenAPI\SDK::builder()
            ...
            ->setPort(CommonHelpers::getHttpBinPort())
            ->build();

        $this->assertEquals('http://127.0.0.1:' . CommonHelpers::getHttpBinPort(), Utils\Utils::templateUrl($sdk->sdkConfiguration->getServerUrl(), $sdk->sdkConfiguration->getServerVariables()));
    ...
    public function testSelectGlobalServerByNameWithTemplatesBroken(): void
    {
        ...
        $this->assertEquals('http://broken:12345', Utils\Utils::templateUrl($sdk->sdkConfiguration->getServerUrl(), $sdk->sdkConfiguration->getServerVariables()));
