...
const supportedFeatures = {
  ...
  oauth2ClientCredentials: "1.1.7",
  tests: "0.9.6",
  allowReserved: "0.1.1",
  oauth2Password: "0.1.4",
  openEnums: "0.2.0",
  mockServer: "0.1.4",
  customSecuritySchemes: "0.2.0",
  jsonlResponses: "0.2.1",
  customCodeRegions: "0.2.2",
  hiddenGlobals: "0.1.0",
  uploadStreams: "0.1.0",
  modelNamespaces: "0.1.2",
};
...
function isTestSkipped(test: string): boolean {
  return [
    ...
    // The following two might not be working on test server??
    ...
    "auth-custom-security-scheme-only", // disabled in .github/workflows/test.yml
...
function isFeatureEnabled(feature: string, config: any): boolean {
  return false;
}
