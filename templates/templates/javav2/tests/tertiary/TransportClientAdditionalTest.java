...
import static org.openapis.tertiary.openapi.Helpers.API_TEST_SERVICE_URL;
...
import org.openapis.tertiary.openapi.utils.JSON;
...
public class TransportClientAdditionalTest {
    ...
    public void testDuplicateHeadersRoundTripThroughOkHttp() throws Exception {
        ...
        try (InputStream ignored = response.body()) {
            ...
            assertEquals(Java8Compat.listOf("first", "second"),
    ...
    private static JsonNode readJson(HttpResponse<InputStream> response) throws Exception {
        try (InputStream in = response.body()) {
            ...
            return JSON.getMapper().readTree(bytes);
        }
    }
