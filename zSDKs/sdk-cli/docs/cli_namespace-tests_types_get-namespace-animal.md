...
```
cli namespace-tests types get-namespace-animal [flags]
```
...
```
  -h, --help   help for get-namespace-animal
```
...
* `cli namespace-tests types get-namespace-animal --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli namespace-tests types get-namespace-animal --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
