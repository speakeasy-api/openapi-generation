## cli get-request-body-flattened-away

Get Request Body Flattened Away
...
```
cli get-request-body-flattened-away [flags]
```
...
```
  -h, --help   help for get-request-body-flattened-away
```
...
* `cli get-request-body-flattened-away --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli get-request-body-flattened-away --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
