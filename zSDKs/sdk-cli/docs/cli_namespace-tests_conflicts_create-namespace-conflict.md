## cli namespace-tests conflicts create-namespace-conflict
...
```
cli namespace-tests conflicts create-namespace-conflict [flags]
```

### Examples

```
  cli conflicts create-namespace-conflict --id pet-foo-123 --name Fluffy --species cat
```
...
```
      ...
      --errors string       A field name that often collides
  -h, --help                help for create-namespace-conflict
      --id string           [required]
      --models string       A field name that often collides
      --name string         [required]
      --operations string   A field name that often collides
      --request string      A field name that often collides
      --species string      The species of the pet (e.g., dog, cat) [required]
      --utils string        A field name that often collides
```
