## cli namespace-tests single-foo

Operations for single-foo
...
```
cli namespace-tests single-foo [flags]
```

### Options

```
  -h, --help   help for single-foo
```
...
* [cli namespace-tests single-foo create-single-namespace-foo-pet](cli_namespace-tests_single-foo_create-single-namespace-foo-pet.md)	 - Create Single Namespace Foo Pet
* [cli namespace-tests single-foo get-single-namespace-foo-pet](cli_namespace-tests_single-foo_get-single-namespace-foo-pet.md)	 - Get Single Namespace Foo Pet
