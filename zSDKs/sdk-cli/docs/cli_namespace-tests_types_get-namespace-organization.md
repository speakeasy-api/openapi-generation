...
```
cli namespace-tests types get-namespace-organization [flags]
```
...
```
  -h, --help   help for get-namespace-organization
```
...
* [cli namespace-tests types](cli_namespace-tests_types.md)	 - Operations for types

### Machine interface

* `cli namespace-tests types get-namespace-organization --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli namespace-tests types get-namespace-organization --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
