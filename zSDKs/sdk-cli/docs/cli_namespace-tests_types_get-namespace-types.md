## cli namespace-tests types get-namespace-types
...
```
cli namespace-tests types get-namespace-types [flags]
```

### Examples

```
  cli types get-namespace-types
```

### Options

```
  -h, --help   help for get-namespace-types
```
