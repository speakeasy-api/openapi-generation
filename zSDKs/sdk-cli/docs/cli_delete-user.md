...
* `cli delete-user --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli delete-user --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
