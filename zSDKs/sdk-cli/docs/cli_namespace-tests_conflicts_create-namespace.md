## cli namespace-tests conflicts create-namespace
...
```
cli namespace-tests conflicts create-namespace [flags]
```
...
```
  ...
  -h, --help                help for create-namespace
...
* `cli namespace-tests conflicts create-namespace --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli namespace-tests conflicts create-namespace --schema` — the exact JSON Schema of the request body (all `$ref`s bundled)
* `cli namespace-tests conflicts create-namespace --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
