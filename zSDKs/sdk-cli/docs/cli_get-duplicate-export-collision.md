...
```
cli get-duplicate-export-collision [flags]
```
...
```
  -h, --help   help for get-duplicate-export-collision
```
...
* `cli get-duplicate-export-collision --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli get-duplicate-export-collision --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
