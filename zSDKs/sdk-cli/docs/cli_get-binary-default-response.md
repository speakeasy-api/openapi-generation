## cli get-binary-default-response

Get Binary Default Response
...
```
cli get-binary-default-response [flags]
```
...
```
  -h, --help                 help for get-binary-default-response
...
* `cli get-binary-default-response --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli get-binary-default-response --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
