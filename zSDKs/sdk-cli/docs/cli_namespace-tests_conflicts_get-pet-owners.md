...
```
cli namespace-tests conflicts get-pet-owners [flags]
```
...
```
  -h, --help   help for get-pet-owners
```
...
* `cli namespace-tests conflicts get-pet-owners --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli namespace-tests conflicts get-pet-owners --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
