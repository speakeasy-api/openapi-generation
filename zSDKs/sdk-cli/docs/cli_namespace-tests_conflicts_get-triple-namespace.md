...
```
cli namespace-tests conflicts get-triple-namespace [flags]
```
...
```
  -h, --help   help for get-triple-namespace
```
...
* `cli namespace-tests conflicts get-triple-namespace --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli namespace-tests conflicts get-triple-namespace --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
