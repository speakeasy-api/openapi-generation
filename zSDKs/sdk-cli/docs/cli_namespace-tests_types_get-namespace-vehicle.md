...
```
cli namespace-tests types get-namespace-vehicle [flags]
```
...
```
  -h, --help   help for get-namespace-vehicle
```
...
* `cli namespace-tests types get-namespace-vehicle --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli namespace-tests types get-namespace-vehicle --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
