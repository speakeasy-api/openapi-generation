## cli namespace-tests single-bar

Operations for single-bar
...
```
cli namespace-tests single-bar [flags]
```

### Options

```
  -h, --help   help for single-bar
```
...
* [cli namespace-tests single-bar get-single-namespace-bar-pet](cli_namespace-tests_single-bar_get-single-namespace-bar-pet.md)	 - Get Single Namespace Bar Pet
