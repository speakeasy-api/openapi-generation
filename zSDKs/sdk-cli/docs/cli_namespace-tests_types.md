...
```
cli namespace-tests types [flags]
```
...
* [cli namespace-tests types get-namespace](cli_namespace-tests_types_get-namespace.md)	 - Get Namespace Types Test
* [cli namespace-tests types get-namespace-animal](cli_namespace-tests_types_get-namespace-animal.md)	 - Get Namespace Animal (Discriminated Union)
* [cli namespace-tests types get-namespace-organization](cli_namespace-tests_types_get-namespace-organization.md)	 - Get Namespace Organization (Nested Inline Schemas)
* [cli namespace-tests types get-namespace-vehicle](cli_namespace-tests_types_get-namespace-vehicle.md)	 - Get Namespace Vehicle (Non-Discriminated Union)
