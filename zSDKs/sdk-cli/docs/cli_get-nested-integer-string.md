...
```
cli get-nested-integer-string [flags]
```
...
```
  -h, --help   help for get-nested-integer-string
```
...
* `cli get-nested-integer-string --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli get-nested-integer-string --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
