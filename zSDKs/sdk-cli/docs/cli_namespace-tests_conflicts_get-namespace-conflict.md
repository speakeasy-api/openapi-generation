## cli namespace-tests conflicts get-namespace-conflict
...
```
cli namespace-tests conflicts get-namespace-conflict [flags]
```

### Examples

```
  cli conflicts get-namespace-conflict
```

### Options

```
  -h, --help   help for get-namespace-conflict
```
