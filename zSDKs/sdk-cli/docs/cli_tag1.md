...
* [cli tag1 auth](cli_tag1_auth.md)	 - This operation aims at testing available OAuth2 scopes collection:
 - only operation with oauth2 authorizationCode security flow
 - belongs to a subSDK
* [cli tag1 deprecated1](cli_tag1_deprecated1.md)	 - Deprecated Operation
* [cli tag1 list-test1](cli_tag1_list-test1.md)	 - Get Test1
* [cli tag1 post-file-with-encoding](cli_tag1_post-file-with-encoding.md)	 - Post File With Encoding
* [cli tag1 recent](cli_tag1_recent.md)	 - List recent test1 pages via tag1
