...
* `cli tag1 deprecated1 --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli tag1 deprecated1 --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
