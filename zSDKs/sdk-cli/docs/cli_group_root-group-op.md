...
* `cli group root-group-op --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli group root-group-op --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
