...
```
  ...
  -h, --help            help for get-union-errors
...
* `cli get-union-errors --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli get-union-errors --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
