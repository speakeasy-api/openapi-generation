...
```
  -h, --help   help for get-polymorphism
```
...
* `cli get-polymorphism --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli get-polymorphism --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
