...
// initGetTripleNamespaceConflictCmd initializes the get-triple-namespace-conflict command.
func initGetTripleNamespaceConflictCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Annotations: map[string]string{
			"speakeasy_operation": "getTripleNamespaceConflict",
		},
	}
...
// runGetTripleNamespaceConflictCmd executes the get-triple-namespace-conflict command.
func runGetTripleNamespaceConflictCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.NamespaceTests.Conflicts.GetTripleNamespaceConflict(cmd.Context(), sdkOpts...)
	if err != nil {
