...
func (c *clientCredentialsHook) getCredentials(ctx HookContext, source func(ctx context.Context) (any, error)) (*credentials, error) {
	...
	case "create-oas-security-operation":
		return c.getCredentialsCreateOasSecurityOperation(sec)
	case "delete-oas-security-operation":
		return c.getCredentialsDeleteOasSecurityOperation(sec)
	case "get-oas-security-operation":
		return c.getCredentialsGetOasSecurityOperation(sec)
	case "update-oas-security-operation":
		return c.getCredentialsUpdateOasSecurityOperation(sec)
	default:
...
func (c *clientCredentialsHook) getCredentialsCreateOasSecurityOperation(sec any) (*credentials, error) {
	security, ok := sec.(operations.CreateOasSecurityOperationSecurity)

	if !ok {
		return nil, fmt.Errorf("unexpected security type: %T", sec)
	}

	if security.OperationClientCredentials == nil {
		return nil, nil
	}
	secType := reflect.TypeOf(security.OperationClientCredentials)
	if secType.Kind() == reflect.Ptr {
		secType = secType.Elem()
	}
	secValue := reflect.ValueOf(security.OperationClientCredentials)
	if secValue.Kind() == reflect.Ptr {
		secValue = secValue.Elem()
	}
	if security.OperationClientCredentials.TokenURL == "" {
		...
		tokenURLDefault := tokenURLField.Tag.Get("default")
		security.OperationClientCredentials.TokenURL = tokenURLDefault
	}
	...
	return &credentials{
		ClientID:             security.OperationClientCredentials.ClientID,
		ClientSecret:         security.OperationClientCredentials.ClientSecret,
		TokenURL:             security.OperationClientCredentials.TokenURL,
		Scopes:               nil,
		AdditionalProperties: additionalProperties,
	}, nil
}

func (c *clientCredentialsHook) getCredentialsDeleteOasSecurityOperation(sec any) (*credentials, error) {
	security, ok := sec.(operations.DeleteOasSecurityOperationSecurity)
...
func (c *clientCredentialsHook) getCredentialsGetOasSecurityOperation(sec any) (*credentials, error) {
	security, ok := sec.(operations.GetOasSecurityOperationSecurity)
...
func (c *clientCredentialsHook) getCredentialsUpdateOasSecurityOperation(sec any) (*credentials, error) {
	security, ok := sec.(operations.UpdateOasSecurityOperationSecurity)
