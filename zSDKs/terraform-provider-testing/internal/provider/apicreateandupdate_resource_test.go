...
func TestAPICreateAndUpdateResourceLifecycle(t *testing.T) {
	t.Parallel()
	...
	resourceAddress := "testing_api_create_and_update.my_apicreateandupdate"
			...
			// Verifies resource create and read.
			{
				...
				ConfigStateChecks: []statecheck.StateCheck{
					...
					statecheck.ExpectKnownValue(
						resourceAddress,
						tfjsonpath.New("name"),
						knownvalue.StringExact("test-api-resource"),
					),
				},
			},
