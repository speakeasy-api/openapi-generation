...
func TestOASServersOperationDataSource(t *testing.T) {
	t.Parallel()
	...
	dataResourceAddress := "data.testing_oas_servers_operation.test"
	managedResourceAddress := "testing_oas_servers_operation.test"
		...
		Steps: []resource.TestStep{
			// Verifies resource create and read.
			{
				...
				ConfigStateChecks: provider.AllModelFieldCompareChecks(
					&provider.OASServersOperationDataSourceModel{},
