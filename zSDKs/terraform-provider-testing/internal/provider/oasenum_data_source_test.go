...
func TestOASEnumDataSource(t *testing.T) {
	t.Parallel()
	...
	dataResourceAddress := "data.testing_oas_enum.test"
	managedResourceAddress := "testing_oas_enum.test"
		...
		Steps: []resource.TestStep{
			// Verifies resource create and read.
			{
				...
				ConfigStateChecks: provider.AllModelFieldCompareChecks(
					&provider.OASEnumDataSourceModel{},
