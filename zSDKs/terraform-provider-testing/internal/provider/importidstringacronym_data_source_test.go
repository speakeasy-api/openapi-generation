...
func TestImportIDStringAcronymDataSource(t *testing.T) {
	t.Parallel()
	...
	// (like 'api_id') match between data source and managed resource. Since this model
	// only contains the input 'api_id' field, no additional validation is required.
