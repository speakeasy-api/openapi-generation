...
func TestXEntityObjectNestedOptionalDataResource(t *testing.T) {
	t.Parallel()
	...
	dataResourceAddress := "data.testing_x_entity_object_nested_optional.test"
	managedResourceAddress := "testing_x_entity_object_nested_optional.test"
