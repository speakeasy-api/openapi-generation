...
public class RenderAsset {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/assets/render");
    ...
    public static class Sync extends Base implements RequestOperation<RenderAssetRequest, RenderAssetResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RenderAssetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<RenderAssetRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RenderAssetRequest request) {
        ...
        @Override
        public RenderAssetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            RenderAssetResponse.Builder resBuilder = RenderAssetResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            RenderAssetResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    RenderAssetRequest, org.openapis.openapi.models.operations.async.RenderAssetResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RenderAssetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<RenderAssetRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RenderAssetRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.RenderAssetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.RenderAssetResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.RenderAssetResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.RenderAssetResponse res = resBuilder.build();
