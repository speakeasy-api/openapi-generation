...
public class GetDuplicateExportCollision {
    ...
    abstract static class Base {
        ...
        HttpRequest buildRequest() throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/duplicateExportCollision");
    ...
    public static class Sync extends Base implements RequestlessOperation<GetDuplicateExportCollisionResponse> {
        ...
        public HttpResponse<InputStream> doRequest() {
            ...
            try {
                ...
                if (Utils.statusCodeMatches(httpRes.statusCode(), "408")) {
        ...
        @Override
        public GetDuplicateExportCollisionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetDuplicateExportCollisionResponse.Builder resBuilder = GetDuplicateExportCollisionResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetDuplicateExportCollisionResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(
                            Utils.unmarshal(response, new TypeReference<GetDuplicateExportCollisionResponseBody>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "408")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw RequestTimeoutError.from(response);
                } else {
                    throw SDKException.from("Unexpected content-type received: " + contentType, response);
                }
            }
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<
                    org.openapis.openapi.models.operations.async.GetDuplicateExportCollisionResponse> {
        ...
        public CompletableFuture<HttpResponse<Blob>> doRequest() {
            return unchecked(() -> onBuildRequest())
                    ...
                    .handle((resp, err) -> {
                        ...
                        if (Utils.statusCodeMatches(resp.statusCode(), "408")) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetDuplicateExportCollisionResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetDuplicateExportCollisionResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetDuplicateExportCollisionResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetDuplicateExportCollisionResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetDuplicateExportCollisionResponseBody>() {})
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "408")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return RequestTimeoutError.fromAsync(response).thenCompose(CompletableFuture::failedFuture);
                } else {
                    return Utils.createAsyncApiError(response, "Unexpected content-type received: " + contentType);
                }
            }
