...
public class GetTripleNamespaceConflict {
    ...
    abstract static class Base {
        ...
        HttpRequest buildRequest() throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/tripleNamespaceConflict");
    ...
    public static class Sync extends Base implements RequestlessOperation<GetTripleNamespaceConflictResponse> {
        ...
        @Override
        public GetTripleNamespaceConflictResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetTripleNamespaceConflictResponse.Builder resBuilder = GetTripleNamespaceConflictResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetTripleNamespaceConflictResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTripleNamespaceConflictTest(
                            Utils.unmarshal(response, new TypeReference<TripleNamespaceConflictTest>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<org.openapis.openapi.models.operations.async.GetTripleNamespaceConflictResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetTripleNamespaceConflictResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetTripleNamespaceConflictResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetTripleNamespaceConflictResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetTripleNamespaceConflictResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TripleNamespaceConflictTest>() {})
                            .thenApply(res::withTripleNamespaceConflictTest);
                } else {
