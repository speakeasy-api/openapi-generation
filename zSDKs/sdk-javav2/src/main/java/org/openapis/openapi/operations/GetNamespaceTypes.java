...
public class GetNamespaceTypes {
    ...
    abstract static class Base {
        ...
        HttpRequest buildRequest() throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/namespaceTypes");
    ...
    public static class Sync extends Base implements RequestlessOperation<GetNamespaceTypesResponse> {
        ...
        @Override
        public GetNamespaceTypesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetNamespaceTypesResponse.Builder resBuilder = GetNamespaceTypesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetNamespaceTypesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withNamespaceTypesTest(
                            Utils.unmarshal(response, new TypeReference<NamespaceTypesTest>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<org.openapis.openapi.models.operations.async.GetNamespaceTypesResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetNamespaceTypesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetNamespaceTypesResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetNamespaceTypesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetNamespaceTypesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<NamespaceTypesTest>() {})
                            .thenApply(res::withNamespaceTypesTest);
                } else {
