...
public class Attachment {
    ...
    @JsonCreator
    public Attachment(@Nonnull String fileName, @Nonnull Blob content) {
    ...
    public Attachment withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }

    public Attachment withContent(@Nonnull Blob content) {
    ...
    public String toString() {
        return Utils.toString(Attachment.class, "fileName", fileName, "content", content);
    }
