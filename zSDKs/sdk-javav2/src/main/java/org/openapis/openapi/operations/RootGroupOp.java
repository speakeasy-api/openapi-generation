...
public class RootGroupOp {
    ...
    abstract static class Base {
        ...
        HttpRequest buildRequest() throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/group/root");
    ...
    public static class Sync extends Base implements RequestlessOperation<RootGroupOpResponse> {
        ...
        @Override
        public RootGroupOpResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            RootGroupOpResponse.Builder resBuilder = RootGroupOpResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            RootGroupOpResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<org.openapis.openapi.models.operations.async.RootGroupOpResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.RootGroupOpResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.RootGroupOpResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.RootGroupOpResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.RootGroupOpResponse res = resBuilder.build();
