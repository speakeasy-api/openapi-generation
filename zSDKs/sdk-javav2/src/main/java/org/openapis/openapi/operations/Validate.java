...
import org.openapis.openapi.models.operations.ValidateResponseBody;
...
public class Validate {
    ...
    abstract static class Base {
        ...
        HttpRequest buildRequest() throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/auth/validate");
    ...
    public static class Sync extends Base implements RequestlessOperation<ValidateResponse> {
        ...
        @Override
        public ValidateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ValidateResponse.Builder resBuilder = ValidateResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ValidateResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ValidateResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<org.openapis.openapi.models.operations.async.ValidateResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.ValidateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.ValidateResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.ValidateResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.ValidateResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ValidateResponseBody>() {})
