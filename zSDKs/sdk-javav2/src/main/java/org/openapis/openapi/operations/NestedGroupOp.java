...
public class NestedGroupOp {
    ...
    abstract static class Base {
        ...
        HttpRequest buildRequest() throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/group/nested");
    ...
    public static class Sync extends Base implements RequestlessOperation<NestedGroupOpResponse> {
        ...
        @Override
        public NestedGroupOpResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            NestedGroupOpResponse.Builder resBuilder = NestedGroupOpResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            NestedGroupOpResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<org.openapis.openapi.models.operations.async.NestedGroupOpResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.NestedGroupOpResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.NestedGroupOpResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.NestedGroupOpResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.NestedGroupOpResponse res = resBuilder.build();
