...
public class CreateNamespaceConflict {
    ...
    public static class Sync extends Base implements RequestOperation<Pet, CreateNamespaceConflictResponse> {
        ...
        private HttpRequest onBuildRequest(Pet request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Pet>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Pet request) {
        ...
        @Override
        public CreateNamespaceConflictResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateNamespaceConflictResponse.Builder resBuilder = CreateNamespaceConflictResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateNamespaceConflictResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPet(
                            Utils.unmarshal(response, new TypeReference<org.openapis.openapi.models.bar.Pet>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Pet, org.openapis.openapi.models.operations.async.CreateNamespaceConflictResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(Pet request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Pet>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(Pet request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.CreateNamespaceConflictResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.CreateNamespaceConflictResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.CreateNamespaceConflictResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.CreateNamespaceConflictResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<org.openapis.openapi.models.bar.Pet>() {})
                            .thenApply(res::withPet);
                } else {
