...
public class TestEndpoint {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/test/endpoint/{testName}", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<TestEndpointRequest, TestEndpointResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(TestEndpointRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, TestEndpointRequest.class, new TypeReference<TestEndpointRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TestEndpointRequest request) {
        ...
        @Override
        public TestEndpointResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            TestEndpointResponse.Builder resBuilder = TestEndpointResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            TestEndpointResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    TestEndpointRequest, org.openapis.openapi.models.operations.async.TestEndpointResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(TestEndpointRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, TestEndpointRequest.class, new TypeReference<TestEndpointRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TestEndpointRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.TestEndpointResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.TestEndpointResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.TestEndpointResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.TestEndpointResponse res = resBuilder.build();
