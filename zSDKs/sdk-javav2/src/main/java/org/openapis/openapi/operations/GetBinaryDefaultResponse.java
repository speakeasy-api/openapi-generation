...
public class GetBinaryDefaultResponse {
    ...
    abstract static class Base {
        ...
        HttpRequest buildRequest() throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/binaryDefaultResponse");
    ...
    public static class Sync extends Base implements RequestlessOperation<GetBinaryDefaultResponseResponse> {
        ...
        @Override
        public GetBinaryDefaultResponseResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetBinaryDefaultResponseResponse.Builder resBuilder = GetBinaryDefaultResponseResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);
            if (Utils.statusCodeMatches(response.statusCode(), "default")
                    && Utils.contentTypeMatches(contentType, "application/octet-stream")) {
                resBuilder.bytes(response.body());
            }

            GetBinaryDefaultResponseResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<org.openapis.openapi.models.operations.async.GetBinaryDefaultResponseResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetBinaryDefaultResponseResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetBinaryDefaultResponseResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetBinaryDefaultResponseResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            if (Utils.statusCodeMatches(response.statusCode(), "default")
            ...
            org.openapis.openapi.models.operations.async.GetBinaryDefaultResponseResponse res = resBuilder.build();
