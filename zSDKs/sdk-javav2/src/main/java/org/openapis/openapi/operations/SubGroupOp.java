...
public class SubGroupOp {
    ...
    abstract static class Base {
        ...
        HttpRequest buildRequest() throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/group/subgroup");
    ...
    public static class Sync extends Base implements RequestlessOperation<SubGroupOpResponse> {
        ...
        @Override
        public SubGroupOpResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            SubGroupOpResponse.Builder resBuilder = SubGroupOpResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            SubGroupOpResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<org.openapis.openapi.models.operations.async.SubGroupOpResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.SubGroupOpResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.SubGroupOpResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.SubGroupOpResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.SubGroupOpResponse res = resBuilder.build();
