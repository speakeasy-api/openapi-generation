...
public class GetPositionalDefault {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/positionalDefault/{id}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPositionalDefaultRequest, GetPositionalDefaultResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetPositionalDefaultRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPositionalDefaultRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPositionalDefaultRequest request) {
        ...
        @Override
        public GetPositionalDefaultResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetPositionalDefaultResponse.Builder resBuilder = GetPositionalDefaultResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetPositionalDefaultResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    org.openapis.openapi.models.operations.async.GetPositionalDefaultResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetPositionalDefaultRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPositionalDefaultRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPositionalDefaultRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetPositionalDefaultResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetPositionalDefaultResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetPositionalDefaultResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetPositionalDefaultResponse res = resBuilder.build();
