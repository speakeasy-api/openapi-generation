...
public class GetEmptyObjectError {
    ...
    abstract static class Base {
        ...
        HttpRequest buildRequest() throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/emptyObjectError");
    ...
    public static class Sync extends Base implements RequestlessOperation<GetEmptyObjectErrorResponse> {
        ...
        @Override
        public GetEmptyObjectErrorResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetEmptyObjectErrorResponse.Builder resBuilder = GetEmptyObjectErrorResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetEmptyObjectErrorResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "500")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw FailedResponseException.from(response);
                } else {
                    throw SDKException.from("Unexpected content-type received: " + contentType, response);
                }
            }
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<org.openapis.openapi.models.operations.async.GetEmptyObjectErrorResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetEmptyObjectErrorResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetEmptyObjectErrorResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetEmptyObjectErrorResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetEmptyObjectErrorResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetEmptyObjectErrorResponseBody>() {})
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "500")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return FailedResponseException.fromAsync(response).thenCompose(CompletableFuture::failedFuture);
                } else {
                    return Utils.createAsyncApiError(response, "Unexpected content-type received: " + contentType);
                }
            }
