...
public class BinaryAndStringUpload {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/binaryAndStringUpload");
    ...
    public static class Sync extends Base
            implements RequestOperation<BinaryAndStringUploadRequest, BinaryAndStringUploadResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(BinaryAndStringUploadRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<BinaryAndStringUploadRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(BinaryAndStringUploadRequest request) {
        ...
        @Override
        public BinaryAndStringUploadResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            BinaryAndStringUploadResponse.Builder resBuilder = BinaryAndStringUploadResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            BinaryAndStringUploadResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    org.openapis.openapi.models.operations.async.BinaryAndStringUploadResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(BinaryAndStringUploadRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<BinaryAndStringUploadRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(BinaryAndStringUploadRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.BinaryAndStringUploadResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.BinaryAndStringUploadResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.BinaryAndStringUploadResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.BinaryAndStringUploadResponse res = resBuilder.build();
