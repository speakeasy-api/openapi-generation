...
public class OperationWithLeadingAndTrailingUnderscores {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "_operation_with_leading_and_trailing_underscores_",
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/test_operation_id_with_underscores");
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(OperationWithLeadingAndTrailingUnderscoresRequest request) throws Exception {
            HttpRequest req = buildRequest(request, OperationWithLeadingAndTrailingUnderscoresRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(OperationWithLeadingAndTrailingUnderscoresRequest request) {
            HttpRequest r = unchecked(() -> onBuildRequest(request)).get();
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (!Utils.statusCodeMatches(httpRes.statusCode(), "200", "404", "5XX")) {
        ...
        @Override
        public OperationWithLeadingAndTrailingUnderscoresResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            OperationWithLeadingAndTrailingUnderscoresResponse.Builder resBuilder =
                    OperationWithLeadingAndTrailingUnderscoresResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            OperationWithLeadingAndTrailingUnderscoresResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "3XX")) {
                // no content
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    OperationWithLeadingAndTrailingUnderscoresRequest,
                    org.openapis.openapi.models.operations.async.OperationWithLeadingAndTrailingUnderscoresResponse> {
        ...
        public CompletableFuture<HttpResponse<Blob>> doRequest(
            ...
            return unchecked(() -> onBuildRequest(request))
                    ...
                    .handle((resp, err) -> {
                        ...
                        if (!Utils.statusCodeMatches(resp.statusCode(), "200", "404", "5XX")) {
        ...
        public CompletableFuture<
            ...
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.OperationWithLeadingAndTrailingUnderscoresResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.OperationWithLeadingAndTrailingUnderscoresResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.OperationWithLeadingAndTrailingUnderscoresResponse res =
                    resBuilder.build();
