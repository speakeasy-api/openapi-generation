...
public class PostFileWithEncoding {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/fileWithEncoding");
    ...
    public static class Sync extends Base
            implements RequestOperation<PostFileWithEncodingRequest, PostFileWithEncodingResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostFileWithEncodingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PostFileWithEncodingRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostFileWithEncodingRequest request) {
        ...
        @Override
        public PostFileWithEncodingResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            PostFileWithEncodingResponse.Builder resBuilder = PostFileWithEncodingResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            PostFileWithEncodingResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(
                            Utils.unmarshal(response, new TypeReference<PostFileWithEncodingResponseBody>() {}));
                } else {
                    throw SDKException.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "415")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    org.openapis.openapi.models.operations.async.PostFileWithEncodingResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostFileWithEncodingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PostFileWithEncodingRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostFileWithEncodingRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostFileWithEncodingResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostFileWithEncodingResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostFileWithEncodingResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostFileWithEncodingResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PostFileWithEncodingResponseBody>() {})
