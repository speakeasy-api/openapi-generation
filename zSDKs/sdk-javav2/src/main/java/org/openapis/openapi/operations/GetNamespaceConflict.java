...
public class GetNamespaceConflict {
    ...
    public static class Sync extends Base implements RequestlessOperation<GetNamespaceConflictResponse> {
        ...
        @Override
        public GetNamespaceConflictResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetNamespaceConflictResponse.Builder resBuilder = GetNamespaceConflictResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetNamespaceConflictResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withNamespaceConflictTest(
                            Utils.unmarshal(response, new TypeReference<NamespaceConflictTest>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<org.openapis.openapi.models.operations.async.GetNamespaceConflictResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetNamespaceConflictResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetNamespaceConflictResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetNamespaceConflictResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetNamespaceConflictResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<NamespaceConflictTest>() {})
                            .thenApply(res::withNamespaceConflictTest);
                } else {
