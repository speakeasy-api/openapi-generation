...
public class GetSingleNamespaceBarPet {
    ...
    abstract static class Base {
        ...
        HttpRequest buildRequest() throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/singleNamespace/bar/pet");
    ...
    public static class Sync extends Base implements RequestlessOperation<GetSingleNamespaceBarPetResponse> {
        ...
        @Override
        public GetSingleNamespaceBarPetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetSingleNamespaceBarPetResponse.Builder resBuilder = GetSingleNamespaceBarPetResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetSingleNamespaceBarPetResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<org.openapis.openapi.models.operations.async.GetSingleNamespaceBarPetResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetSingleNamespaceBarPetResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetSingleNamespaceBarPetResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetSingleNamespaceBarPetResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetSingleNamespaceBarPetResponse res = resBuilder.build();
