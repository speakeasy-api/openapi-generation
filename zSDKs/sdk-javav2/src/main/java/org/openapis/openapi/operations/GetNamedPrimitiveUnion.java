...
public class GetNamedPrimitiveUnion {
    ...
    abstract static class Base {
        ...
        HttpRequest buildRequest() throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/namedPrimitiveUnion");
    ...
    public static class Sync extends Base implements RequestlessOperation<GetNamedPrimitiveUnionResponse> {
        ...
        @Override
        public GetNamedPrimitiveUnionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetNamedPrimitiveUnionResponse.Builder resBuilder = GetNamedPrimitiveUnionResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetNamedPrimitiveUnionResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSomeUnion(Utils.unmarshal(response, new TypeReference<SomeUnion>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<org.openapis.openapi.models.operations.async.GetNamedPrimitiveUnionResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetNamedPrimitiveUnionResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetNamedPrimitiveUnionResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetNamedPrimitiveUnionResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetNamedPrimitiveUnionResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SomeUnion>() {})
                            .thenApply(res::withSomeUnion);
                } else {
