...
public class GetFullyFlattenedRequest {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/fullyFlattenedRequest");
            ...
            Utils.configureSecurity(req, this.sdkConfiguration.securitySource().getSecurity(), "option6", "myApiKey");
    ...
    public static class Sync extends Base
            implements RequestOperation<GetFullyFlattenedRequestRequest, GetFullyFlattenedRequestResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetFullyFlattenedRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    GetFullyFlattenedRequestRequest.class,
                    new TypeReference<GetFullyFlattenedRequestRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetFullyFlattenedRequestRequest request) {
        ...
        @Override
        public GetFullyFlattenedRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetFullyFlattenedRequestResponse.Builder resBuilder = GetFullyFlattenedRequestResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetFullyFlattenedRequestResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    org.openapis.openapi.models.operations.async.GetFullyFlattenedRequestResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetFullyFlattenedRequestRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    GetFullyFlattenedRequestRequest.class,
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetFullyFlattenedRequestRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetFullyFlattenedRequestResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetFullyFlattenedRequestResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetFullyFlattenedRequestResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetFullyFlattenedRequestResponse res = resBuilder.build();
