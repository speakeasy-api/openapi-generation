...
public class CreateWithUnion {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/unionRequestBody");
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "shapeRequest", "json", false);
    ...
    public static class Sync extends Base implements RequestOperation<CreateWithUnionRequest, CreateWithUnionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateWithUnionRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, CreateWithUnionRequest.class, new TypeReference<CreateWithUnionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateWithUnionRequest request) {
        ...
        @Override
        public CreateWithUnionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateWithUnionResponse.Builder resBuilder = CreateWithUnionResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateWithUnionResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(
                            Utils.unmarshal(response, new TypeReference<CreateWithUnionResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    CreateWithUnionRequest, org.openapis.openapi.models.operations.async.CreateWithUnionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateWithUnionRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, CreateWithUnionRequest.class, new TypeReference<CreateWithUnionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateWithUnionRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.CreateWithUnionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.CreateWithUnionResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.CreateWithUnionResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.CreateWithUnionResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateWithUnionResponseBody>() {})
