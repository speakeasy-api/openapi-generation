...
public class DeleteUser {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/user/{id}", request, null);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteUserRequest, org.openapis.openapi.models.operations.async.DeleteUserResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeleteUserResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeleteUserResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeleteUserResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.DeleteUserResponse res = resBuilder.build();
