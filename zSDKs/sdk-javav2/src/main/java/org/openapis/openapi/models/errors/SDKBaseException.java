...
public abstract class SDKBaseException extends RuntimeException {
    ...
    public SDKBaseException withCode(int code) {
        this.code = code;
        return this;
    }

    public SDKBaseException withBody(@Nullable byte[] body) {
        Utils.checkNotNull(body, "body");
        this.body = body;
        return this;
    }

    public SDKBaseException withRawResponse(HttpResponse<?> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
