...
public class CreateSingleNamespaceFooPet {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/singleNamespace/foo/pet");
    ...
    public static class Sync extends Base implements RequestOperation<Pet, CreateSingleNamespaceFooPetResponse> {
        ...
        @Override
        public CreateSingleNamespaceFooPetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateSingleNamespaceFooPetResponse.Builder resBuilder = CreateSingleNamespaceFooPetResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateSingleNamespaceFooPetResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPet(Utils.unmarshal(response, new TypeReference<Pet>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    Pet, org.openapis.openapi.models.operations.async.CreateSingleNamespaceFooPetResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.CreateSingleNamespaceFooPetResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.CreateSingleNamespaceFooPetResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.CreateSingleNamespaceFooPetResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.CreateSingleNamespaceFooPetResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Pet>() {})
