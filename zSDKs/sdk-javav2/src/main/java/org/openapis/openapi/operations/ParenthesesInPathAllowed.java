...
public class ParenthesesInPathAllowed {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/jobs/job({id})", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "templateBracesTest", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<ParenthesesInPathAllowedRequest, ParenthesesInPathAllowedResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ParenthesesInPathAllowedRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    ParenthesesInPathAllowedRequest.class,
                    new TypeReference<ParenthesesInPathAllowedRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ParenthesesInPathAllowedRequest request) {
        ...
        @Override
        public ParenthesesInPathAllowedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ParenthesesInPathAllowedResponse.Builder resBuilder = ParenthesesInPathAllowedResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ParenthesesInPathAllowedResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTemplateBracesTest(
                            Utils.unmarshal(response, new TypeReference<TemplateBracesTest>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    org.openapis.openapi.models.operations.async.ParenthesesInPathAllowedResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ParenthesesInPathAllowedRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    ParenthesesInPathAllowedRequest.class,
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ParenthesesInPathAllowedRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.ParenthesesInPathAllowedResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.ParenthesesInPathAllowedResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.ParenthesesInPathAllowedResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.ParenthesesInPathAllowedResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TemplateBracesTest>() {})
                            .thenApply(res::withTemplateBracesTest);
                } else {
