...
public class UrlValidationStressTest {
    ...
    abstract static class Base {
        ...
        HttpRequest buildRequest() throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/AZaz09-._~!$&'*+,;=:@/%20%25/-._~!$&'()*+,;=:@");
    ...
    public static class Sync extends Base implements RequestlessOperation<UrlValidationStressTestResponse> {
        ...
        @Override
        public UrlValidationStressTestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UrlValidationStressTestResponse.Builder resBuilder = UrlValidationStressTestResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UrlValidationStressTestResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<org.openapis.openapi.models.operations.async.UrlValidationStressTestResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.UrlValidationStressTestResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.UrlValidationStressTestResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.UrlValidationStressTestResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.UrlValidationStressTestResponse res = resBuilder.build();
