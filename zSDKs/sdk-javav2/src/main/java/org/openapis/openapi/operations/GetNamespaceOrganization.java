...
public class GetNamespaceOrganization {
    ...
    abstract static class Base {
        ...
        HttpRequest buildRequest() throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/namespaceOrganization");
    ...
    public static class Sync extends Base implements RequestlessOperation<GetNamespaceOrganizationResponse> {
        ...
        @Override
        public GetNamespaceOrganizationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetNamespaceOrganizationResponse.Builder resBuilder = GetNamespaceOrganizationResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetNamespaceOrganizationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<org.openapis.openapi.models.operations.async.GetNamespaceOrganizationResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetNamespaceOrganizationResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetNamespaceOrganizationResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetNamespaceOrganizationResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetNamespaceOrganizationResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Organization>() {})
                            .thenApply(res::withOrganization);
                } else {
