...
public class CreateUser {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/user");
    ...
    public static class Sync extends Base implements RequestOperation<BaseUser, CreateUserResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(BaseUser request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<BaseUser>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(BaseUser request) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<BaseUser, org.openapis.openapi.models.operations.async.CreateUserResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(BaseUser request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<BaseUser>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(BaseUser request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.CreateUserResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.CreateUserResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.CreateUserResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.CreateUserResponse res = resBuilder.build();
