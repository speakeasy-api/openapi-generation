...
public class GetRequestBodyFlattenedAway {
    ...
    abstract static class Base {
        ...
        public Base(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            ...
            this.sdkConfiguration.globals
                    .getParam("queryParam", "loneQueryParam")
                    .ifPresent(param -> operationGlobals.putParam("queryParam", "loneQueryParam", param));
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/requestBodyFlattenedAway");
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRequestBodyFlattenedAwayRequest, GetRequestBodyFlattenedAwayResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetRequestBodyFlattenedAwayRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRequestBodyFlattenedAwayRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRequestBodyFlattenedAwayRequest request) {
        ...
        @Override
        public GetRequestBodyFlattenedAwayResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetRequestBodyFlattenedAwayResponse.Builder resBuilder = GetRequestBodyFlattenedAwayResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetRequestBodyFlattenedAwayResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    org.openapis.openapi.models.operations.async.GetRequestBodyFlattenedAwayResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetRequestBodyFlattenedAwayRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetRequestBodyFlattenedAwayRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRequestBodyFlattenedAwayRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetRequestBodyFlattenedAwayResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetRequestBodyFlattenedAwayResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetRequestBodyFlattenedAwayResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetRequestBodyFlattenedAwayResponse res = resBuilder.build();
