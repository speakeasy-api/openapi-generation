...
public class GetSingleNamespaceFooPet {
    ...
    public static class Sync extends Base implements RequestlessOperation<GetSingleNamespaceFooPetResponse> {
        ...
        @Override
        public GetSingleNamespaceFooPetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetSingleNamespaceFooPetResponse.Builder resBuilder = GetSingleNamespaceFooPetResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetSingleNamespaceFooPetResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<org.openapis.openapi.models.operations.async.GetSingleNamespaceFooPetResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetSingleNamespaceFooPetResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetSingleNamespaceFooPetResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetSingleNamespaceFooPetResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetSingleNamespaceFooPetResponse res = resBuilder.build();
