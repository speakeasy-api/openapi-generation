...
public class GetUser {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetUserRequest, org.openapis.openapi.models.operations.async.GetUserResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetUserResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetUserResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetUserResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetUserResponse res = resBuilder.build();
