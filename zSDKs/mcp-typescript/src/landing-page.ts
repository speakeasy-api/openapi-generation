...
<head>
    ...
    <title>openapi MCP</title>
    <meta name="description" content="Install openapi MCP server.">
    <meta property="og:type" content="website">
    <meta property="og:title" content="openapi - MCP Server">
    <meta property="og:description" content="Install openapi MCP server.">
    <meta property="twitter:card" content="summary">
    <meta property="twitter:title" content="openapi - MCP Server">
    <meta property="twitter:description" content="Install openapi MCP server.">
          ...
          <div class="header container">
            <div class="mcp-meta">
              ...
              <div class="header-content">
                <div class="mcp-name">openapi</div>
    ...
    <div class="modal" id="claude-desktop-modal">
      ...
      <div class="content-slot">
        ...
        <div class="instruction-item">
          <a href="https://github.com/speakeasy-sdks/test-sdk/releases/download/v0.0.1/mcp-server.mcpb" download="mcp-server.mcpb" class="action-button header-action" style="display: inline-flex; margin-bottom: 16px;">
            📥 Download MCP Bundle
          </a>
        </div>
