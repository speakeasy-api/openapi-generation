    ...
    [
      {
        type: "http:basic",
        value: {
          username: security?.UserPassAuth?.username || env().SPK_USERNAME,
          password: security?.UserPassAuth?.password || env().SPK_PASSWORD,
        },
      },
    ],
    [
      {
        ...
        type: "http:bearer",
        value: security?.Option2?.bearerAuth || env().SPK_BEARER_AUTH,
      },
      {
        fieldName: "api_key",
        type: "apiKey:header",
        value: security?.Option2?.MyApiKey || env().SPK_MY_API_KEY,
      },
    ],
    [
      {
        fieldName: "Authorization",
        type: "oauth2",
        value: security?.Option3?.oauth2 || env().SPK_OAUTH2,
      },
    ],
    [
      {
        fieldName: "appId",
        type: "http:custom",
        value: security?.Option4?.appId || env().SPK_APP_ID,
      },
      {
        fieldName: "secret",
        type: "http:custom",
        value: security?.Option4?.secret || env().SPK_SECRET,
      },
    ],
    [
      {
        fieldName: "Authorization",
        type: "oauth2",
        value: security?.Option5?.mobileAuth || env().SPK_MOBILE_AUTH,
      },
    ],
    [
      {
        fieldName: "Authorization",
        type: "oauth2",
        value: security?.Option6?.clientCredentials
          || env().SPK_CLIENT_CREDENTIALS,
      },
    ],
    [
      {
        fieldName: "api_key",
        type: "apiKey:header",
        value: security?.MyApiKey?.MyApiKey || env().SPK_MY_API_KEY,
      },
    ],
  ];
