...
export function buildSDK(
  ...
  const flags = {
    ...
    "client-credentials": resolveHeader(
      headers,
      "client-credentials",
      z.string(),
  ...
  return new SDKCore({
    ...
    queryParam1: resolveHeader(
      headers,
      "query-param1",
      z.string(),
      cliFlags["query-param1"],
      disableStaticAuth,
    ),
    deprecatedQueryParam1: resolveHeader(
      headers,
      "deprecated-query-param1",
      z.string(),
      cliFlags["deprecated-query-param1"],
      disableStaticAuth,
    ),
    deprecatedQueryParam2: resolveHeader(
      headers,
      "deprecated-query-param2",
      z.string(),
      cliFlags["deprecated-query-param2"],
      disableStaticAuth,
    ),
    loneQueryParam: resolveHeader(
      headers,
      "lone-query-param",
      z.string(),
      cliFlags["lone-query-param"],
      disableStaticAuth,
    ),
    serverIdx: cliFlags["server-index"],
    subdomain: resolveHeader(
      headers,
      "subdomain",
      z.string(),
      cliFlags.subdomain,
    ...
    version: resolveHeader(
      headers,
      "api-version",
      z.string(),
      cliFlags["api-version"],
      disableStaticAuth,
    ),
    HostName: resolveHeader(
      headers,
      "api-host-name",
      z.string(),
      cliFlags["api-host-name"],
      disableStaticAuth,
    ),
    PORT: resolveHeader(
      headers,
      "api-port",
      ServerPORT$zodSchema,
      cliFlags["api-port"],
      disableStaticAuth,
    ),
