...
//
//	// Set to value
//	user.Name = FromVal("John")
//
//	// Set to value (pointer form)
//	name := "John"
//	user.Name = From(&name)
//
...
// FromVal creates a new OptionalNullable set to the given value.
// This is a convenience constructor that avoids needing to create
// a temporary variable and take its address.
//
// Examples:
//
//	FromVal("hello")  // set to "hello"
//	FromVal(42)       // set to 42
func FromVal[T any](value T) OptionalNullable[T] {
	return map[bool]*T{
		true: &value,
	}
}
