...
<!-- UsageSnippet language="python" operationID="subGroupOp" method="get" path="/group/subgroup" -->
```python
# Synchronous Example
...
with SDK() as sdk:
    ...
    sdk.group.sub_group.sub_group_op()
...
async def main():
    ...
    async with AsyncSDK() as sdk:
        ...
        await sdk.group.sub_group.sub_group_op()
