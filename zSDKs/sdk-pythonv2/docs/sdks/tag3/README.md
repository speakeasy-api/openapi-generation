...
with SDK(
    ...
    res = sdk.test_group.tag3.post_test(obj=speakeasy.new_openapi.ExhaustiveObject(
        str_="example",
        bool_=True,
        integer=999999,
        int32=1,
...
async def main():
    ...
    async with AsyncSDK(
        ...
        res = await sdk.test_group.tag3.post_test(obj=speakeasy.new_openapi.ExhaustiveObject(
            str_="example",
            bool_=True,
            integer=999999,
            int32=1,
