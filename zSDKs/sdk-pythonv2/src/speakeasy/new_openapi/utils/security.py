...
def get_security_from_env(security: Any, security_class: Any) -> Optional[BaseModel]:
    ...
    if os.getenv("SPEAKEASY_USERNAME"):
        security_dict.setdefault("user_pass_auth", {})["username"] = os.getenv(
            "SPEAKEASY_USERNAME"
        )

    if os.getenv("SPEAKEASY_PASSWORD"):
        security_dict.setdefault("user_pass_auth", {})["password"] = os.getenv(
            "SPEAKEASY_PASSWORD"
        )

    if os.getenv("SPEAKEASY_BEARER_AUTH"):
        security_dict.setdefault("option2", {})["bearer_auth"] = os.getenv(
            "SPEAKEASY_BEARER_AUTH"
        )

    if os.getenv("SPEAKEASY_MY_API_KEY"):
        security_dict.setdefault("option2", {})["my_api_key"] = os.getenv(
            "SPEAKEASY_MY_API_KEY"
        )

    if os.getenv("SPEAKEASY_OAUTH2"):
        security_dict.setdefault("option3", {})["oauth2"] = os.getenv(
            "SPEAKEASY_OAUTH2"
        )

    if os.getenv("SPEAKEASY_APP_ID"):
        security_dict.setdefault("option4", {})["app_id"] = os.getenv(
            "SPEAKEASY_APP_ID"
        )

    if os.getenv("SPEAKEASY_SECRET"):
        security_dict.setdefault("option4", {})["secret"] = os.getenv(
            "SPEAKEASY_SECRET"
        )

    if os.getenv("SPEAKEASY_MOBILE_AUTH"):
        security_dict.setdefault("option5", {})["mobile_auth"] = os.getenv(
            "SPEAKEASY_MOBILE_AUTH"
        )

    if os.getenv("SPEAKEASY_CLIENT_ID"):
        security_dict.setdefault("option6", {})["client_id"] = os.getenv(
            "SPEAKEASY_CLIENT_ID"
        )

    if os.getenv("SPEAKEASY_CLIENT_SECRET"):
        security_dict.setdefault("option6", {})["client_secret"] = os.getenv(
            "SPEAKEASY_CLIENT_SECRET"
        )

    if os.getenv("SPEAKEASY_TOKEN_URL"):
        security_dict.setdefault("option6", {})["token_url"] = os.getenv(
            "SPEAKEASY_TOKEN_URL"
        )

    if os.getenv("SPEAKEASY_MY_API_KEY"):
        security_dict.setdefault("my_api_key", {})["my_api_key"] = os.getenv(
            "SPEAKEASY_MY_API_KEY"
        )
