...
<!-- UsageSnippet language="csharp" operationID="getNamespaceConflict" method="get" path="/namespaceConflict" -->
```csharp
...
<!-- UsageSnippet language="csharp" operationID="putNamespaceConflict" method="put" path="/namespaceConflict" -->
```csharp
using Speakeasy.OpenAPI;

var sdk = new SDK();

ObjWithRenamedProperties? req = null;

var res = await sdk.NamespaceTests.Conflicts.PutNamespaceConflictAsync(req);
...
<!-- UsageSnippet language="csharp" operationID="createNamespaceConflict" method="post" path="/namespaceConflict" -->
```csharp
using Speakeasy.OpenAPI;
...
<!-- UsageSnippet language="csharp" operationID="getTripleNamespaceConflict" method="get" path="/tripleNamespaceConflict" -->
```csharp
using Speakeasy.OpenAPI;
...
<!-- UsageSnippet language="csharp" operationID="getPetOwners" method="get" path="/petOwners" -->
```csharp
using Speakeasy.OpenAPI;
