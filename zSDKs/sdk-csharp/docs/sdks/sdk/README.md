...
<!-- UsageSnippet language="csharp" operationID="_operation_with_leading_and_trailing_underscores_" method="get" path="/test_operation_id_with_underscores" -->
```csharp
using Speakeasy.OpenAPI;

var sdk = new SDK();

var res = await sdk.OperationWithLeadingAndTrailingUnderscoresAsync(qp1: "renamed");
...
<!-- UsageSnippet language="csharp" operationID="postFile" method="post" path="/file" -->
```csharp
using Speakeasy.OpenAPI;
...
<!-- UsageSnippet language="csharp" operationID="getPolymorphism" method="get" path="/polymorphism" -->
```csharp
using Speakeasy.OpenAPI;
...
<!-- UsageSnippet language="csharp" operationID="getUnionErrors" method="get" path="/unionErrors" -->
```csharp
using Speakeasy.OpenAPI;
...
**[GetUnionErrorsResponse](../../Models/GetUnionErrorsResponse.md)**
...
| ErrorType1       | 500              | application/json |
| ErrorType2       | 500              | application/json |
| TaggedError1     | 4XX              | application/json |
| TaggedError2     | 4XX              | application/json |
| SDKException     | 5XX              | \*/\*            |
...
<!-- UsageSnippet language="csharp" operationID="getRequestBodyFlattenedAway" method="get" path="/requestBodyFlattenedAway" -->
```csharp
using Speakeasy.OpenAPI;
...
<!-- UsageSnippet language="csharp" operationID="getFullyFlattenedRequest" method="post" path="/fullyFlattenedRequest" example="namedExampleThatIsntMatchedAcrossDifferentExamples" -->
```csharp
using Speakeasy.OpenAPI;
...
<!-- UsageSnippet language="csharp" operationID="createWithUnion" method="post" path="/unionRequestBody" -->
```csharp
using Speakeasy.OpenAPI;
...
<!-- UsageSnippet language="csharp" operationID="testEndpoint" method="post" path="/test/endpoint/{testName}" -->
```csharp
using Speakeasy.OpenAPI;

var sdk = new SDK();

var res = await sdk.TestEndpointAsync(
    testName: "<value>",
...
<!-- UsageSnippet language="csharp" operationID="createUser" method="put" path="/user" example="paired-example" -->
```csharp
using Speakeasy.OpenAPI;
...
<!-- UsageSnippet language="csharp" operationID="createUser" method="put" path="/user" example="request-only" -->
```csharp
using Speakeasy.OpenAPI;
...
<!-- UsageSnippet language="csharp" operationID="createUser" method="put" path="/user" example="response-only" -->
```csharp
using Speakeasy.OpenAPI;
...
<!-- UsageSnippet language="csharp" operationID="getUser" method="get" path="/user/{id}" example="success" -->
```csharp
using Speakeasy.OpenAPI;
...
<!-- UsageSnippet language="csharp" operationID="updateUser" method="post" path="/user/{id}" -->
```csharp
using Speakeasy.OpenAPI;
...
<!-- UsageSnippet language="csharp" operationID="deleteUser" method="delete" path="/user/{id}" -->
```csharp
using Speakeasy.OpenAPI;

var sdk = new SDK();

var res = await sdk.DeleteUserAsync(id: "<id>");
...
<!-- UsageSnippet language="csharp" operationID="login" method="get" path="/auth/login" -->
```csharp
using Speakeasy.OpenAPI;

var sdk = new SDK();

var res = await sdk.LoginAsync();
...
<!-- UsageSnippet language="csharp" operationID="validate" method="get" path="/auth/validate" -->
```csharp
using Speakeasy.OpenAPI;

var sdk = new SDK();

var res = await sdk.ValidateAsync();
...
<!-- UsageSnippet language="csharp" operationID="chat" method="post" path="/chat" -->
```csharp
using Speakeasy.OpenAPI;
...
| Parameter                                  | Type                                       | Required                                   | Description                                |
| ------------------------------------------ | ------------------------------------------ | ------------------------------------------ | ------------------------------------------ |
| `request`                                  | [ChatRequest](../../Models/ChatRequest.md) | :heavy_check_mark:                         | The request object to use for the request. |
...
<!-- UsageSnippet language="csharp" operationID="getBinaryDefaultResponse" method="get" path="/binaryDefaultResponse" -->
```csharp
using Speakeasy.OpenAPI;
...
<!-- UsageSnippet language="csharp" operationID="testEnumFormats" method="post" path="/enumFormats" -->
```csharp
using Speakeasy.OpenAPI;
...
var res = await sdk.TestEnumFormatsAsync(req);
...
<!-- UsageSnippet language="csharp" operationID="binaryAndStringUpload" method="post" path="/binaryAndStringUpload" -->
```csharp
using Speakeasy.OpenAPI;
...
BinaryAndStringUploadRequest req = new BinaryAndStringUploadRequest() {
    Binary = System.IO.File.ReadAllBytes("test.json"),
    String = System.IO.File.ReadAllText("test.json"),
};

var res = await sdk.BinaryAndStringUploadAsync(req);
...
<!-- UsageSnippet language="csharp" operationID="getErrorInUnion" method="get" path="/errorInUnion" -->
```csharp
using Speakeasy.OpenAPI;

var sdk = new SDK();

var res = await sdk.GetErrorInUnionAsync();
...
**[GetErrorInUnionResponse](../../Models/GetErrorInUnionResponse.md)**
...
| TaggedError1     | 500              | application/json |
| SDKException     | 4XX, 5XX         | \*/\*            |
...
<!-- UsageSnippet language="csharp" operationID="getDuplicateExportCollision" method="get" path="/duplicateExportCollision" -->
```csharp
using Speakeasy.OpenAPI;
...
<!-- UsageSnippet language="csharp" operationID="getNamedPrimitiveUnion" method="get" path="/namedPrimitiveUnion" -->
```csharp
using Speakeasy.OpenAPI;
...
<!-- UsageSnippet language="csharp" operationID="getEmptyObjectError" method="get" path="/emptyObjectError" -->
```csharp
using Speakeasy.OpenAPI;
...
<!-- UsageSnippet language="csharp" operationID="urlValidationStressTest" method="get" path="/AZaz09-._~!$&'*+,;=:@/%20%25/-._~!$&'()*+,;=:@" -->
```csharp
using Speakeasy.OpenAPI;

var sdk = new SDK();

var res = await sdk.UrlValidationStressTestAsync();
...
<!-- UsageSnippet language="csharp" operationID="parenthesesInPathAllowed" method="post" path="/jobs/job({id})" -->
```csharp
using Speakeasy.OpenAPI;
...
<!-- UsageSnippet language="csharp" operationID="getNestedIntegerString" method="get" path="/nestedIntegerString" -->
```csharp
using Speakeasy.OpenAPI;
...
<!-- UsageSnippet language="csharp" operationID="renderAsset" method="post" path="/assets/render" -->
```csharp
using Speakeasy.OpenAPI;

var sdk = new SDK();

RenderAssetRequest req = new RenderAssetRequest() {
    Prompt = "<value>",
};

var res = await sdk.RenderAssetAsync(req);

// Handle event stream response
var eventStream = res.AssetStream;
if (eventStream != null)
{
    await foreach (AssetStream eventData in eventStream)
    {
        // handle eventData
    }
}
// Handle JSON response
else if (res.AssetResult != null)
{
    // handle JSON response
    var jsonResponse = res.AssetResult;
}
```
...
| Parameter                                                | Type                                                     | Required                                                 | Description                                              |
| -------------------------------------------------------- | -------------------------------------------------------- | -------------------------------------------------------- | -------------------------------------------------------- |
| `request`                                                | [RenderAssetRequest](../../Models/RenderAssetRequest.md) | :heavy_check_mark:                                       | The request object to use for the request.               |

### Response

**[RenderAssetResponse](../../Models/RenderAssetResponse.md)**
...
<!-- UsageSnippet language="csharp" operationID="getAsset" method="get" path="/assets/{id}" -->
```csharp
using Speakeasy.OpenAPI;

var sdk = new SDK();

var res = await sdk.GetAssetAsync(
    id: "<id>",
    stream: true
);

// Handle event stream response
var eventStream = res.AssetStatusStream;
if (eventStream != null)
{
    await foreach (AssetStatusStream eventData in eventStream)
    {
        // handle eventData
    }
}
...
<!-- UsageSnippet language="csharp" operationID="getErrorOnlyExample" method="get" path="/errorOnlyExample" -->
```csharp
using Speakeasy.OpenAPI;
