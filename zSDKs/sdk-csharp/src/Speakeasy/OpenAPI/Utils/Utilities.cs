...
namespace Speakeasy.OpenAPI.Utils
{
    ...
    public class Utilities
    {
        ...
        public static Newtonsoft.Json.Linq.JToken ParseRawToken(string json)
        {
            using (var reader = new JsonTextReader(new System.IO.StringReader(json)) { DateParseHandling = DateParseHandling.None })
            {
                return Newtonsoft.Json.Linq.JToken.Load(reader);
            }
        }
        ...
        public static bool IsModelNamespace(string ns)
        {
            var modelNamespaces = new[] {
                "Speakeasy.OpenAPI",
                "Speakeasy.OpenAPI.Bar",
                "Speakeasy.OpenAPI.Foo",
                "Speakeasy.OpenAPI.Baz",
            };
        ...
        public static bool IsContentTypeMatch(string expected, string? actual)
        {
            ...
            try
            {
                ...
                var parts = mediaType.Split(new char[] { '/' });
                if (parts.Length == 2)
                {
