...
namespace Speakeasy.OpenAPI
{
    ...
    public interface ISubGroup
    {
        ...
        /// </summary>
        Task<SubGroupOpResponse> SubGroupOpAsync();
    }
    ...
    public class SubGroup: ISubGroup
    {
        ...
        public SubGroup(ISpeakeasyHttpClient defaultClient, Func<Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _defaultClient = defaultClient;
            _securitySource = securitySource;
            _serverUrl = serverUrl;
            SDKConfiguration = config;
            Empty = new Empty(_defaultClient, _securitySource, _serverUrl, SDKConfiguration);
        }
        

        
        public async Task<SubGroupOpResponse> SubGroupOpAsync()
        {
            ...
            var response = new SubGroupOpResponse
            {
                StatusCode = httpCode,
