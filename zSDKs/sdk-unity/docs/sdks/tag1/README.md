...
using(var res = await sdk.Tag1.Deprecated1Async())
{
    // handle response
}
...
<!-- UsageSnippet language="unity" operationID="auth" method="get" path="/auth" -->
```csharp
using Speakeasy.OpenAPI;
...
<!-- UsageSnippet language="unity" operationID="listTest1" method="get" path="/test1/{page}" -->
```csharp
using Speakeasy.OpenAPI;
...
<!-- UsageSnippet language="unity" operationID="postFileWithEncoding" method="post" path="/fileWithEncoding" -->
```csharp
using Speakeasy.OpenAPI;
